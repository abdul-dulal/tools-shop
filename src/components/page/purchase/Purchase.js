...
const Purchase = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/product/purchase/${id}`)
  ...
  return (
    <div className="container my-8">
      <div className=" grid grid-cols-2">
        ...
        <div className="flex justify-items-center items-center">
          <div>
            ...
            <p className="text-xl text-primary">Price : $ {purchase.price}</p>
            <p className="mt-2 text-gray-600">
              Santiago travels from his homeland in Spain to the Egyptian desert
              in search of a treasure buried near the Pyramids. Lorem ipsum
            ...
            <div className="mt-5">
              <form onSubmit={handleOrder}>
                ...
                <input
                  ...
                  required
                  class="input input-bordered w-full max-w-xs  block mt-4 placeholder:text-gray-600"
                />
                ...
                <input
                  ...
                  class="input input-bordered w-full max-w-xs  block mt-4 placeholder:text-gray-600"
                />
                <p className="mt-3">Avaiiable Qauntity : {purchase.quantity}</p>
                <input
                  type="submit"
                  value="Placed Order"
      ...
      <div className=" flex gap-10 text-xl font-bload">
        <button
        ...
        <button
          ...
          className={`${
            isActive === "reviews" ? "border-b-4 border-primary" : "to-black"
          }`}
        >
          Rviews
        </button>
